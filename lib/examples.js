(function() {
  var AABBAABBExample, AABBSegmentExample, AABBSweptAABBExample, Example;
  ...
  AABBSegmentExample = (function() {
    __extends(AABBSegmentExample, Example);
  ...
  AABBAABBExample = (function() {
    __extends(AABBAABBExample, Example);
  ...
  AABBSweptAABBExample = (function() {
    __extends(AABBSweptAABBExample, Example);
    ...
    AABBSweptAABBExample.prototype.tick = function(mouseX, mouseY, elapsed) {
      var box, delta, dir, factor, i, length, sweep, _len, _ref, _results;
      this.angle += 0.5 * Math.PI * elapsed;
      ...
      for (i = 0, _len = _ref.length; i < _len; i++) {
        ...
        _results.push(sweep.hit != null ? (this.drawRay(box.pos, dir, length, '#f00'), this.tempBox.pos.x = box.pos.x + delta.x, this.tempBox.pos.y = box.pos.y + delta.y, this.drawAABB(this.tempBox, '#f00'), this.tempBox.pos.x = sweep.pos.x, this.tempBox.pos.y = sweep.pos.y, this.drawAABB(this.tempBox, '#ff0'), this.drawPoint(sweep.hit.pos, '#ff0'), this.drawRay(sweep.hit.pos, sweep.hit.normal, 4, '#ff0', false)) : (this.tempBox.pos.x = sweep.pos.x, this.tempBox.pos.y = sweep.pos.y, this.drawAABB(this.tempBox, '#0f0'), this.drawRay(box.pos, dir, length, '#0f0')));
      }
      return _results;
    };
  ...
  $(document).ready(function() {
    ...
    mouseX = 0;
    mouseY = 0;
    examples = [new AABBSegmentExample(context, width, height), new AABBAABBExample(context, width, height), new AABBSweptAABBExample(context, width, height)];
